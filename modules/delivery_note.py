...
class DeliveryNoteGenerator(BaseGenerator):
    ...
    def __init__(self, parent):
        ...
        self.create_title_section(left_frame_callback=self.create_delivery_info_section)
    ...
    def create_delivery_info_section(self, parent):
        ...
        info_frame = tk.LabelFrame(parent, text="Delivery Information", bg="#F0F0F0", font=("Arial", 12, "bold"))
        info_frame.pack(fill="x", padx=15, pady=10)  # Use pack instead of grid
        ...
        self.customer_entry.grid(row=0, column=1, sticky="ew", padx=5, pady=5)
        ...
        self.date_entry.grid(row=0, column=3, sticky="ew", padx=5, pady=5)
        ...
        self.company_entry.grid(row=1, column=1, sticky="ew", padx=5, pady=5)
        ...
        self.address_entry.grid(row=1, column=3, sticky="ew", padx=5, pady=5)
        ...
        self.fax_entry.grid(row=2, column=3, sticky="ew", padx=5, pady=5)
        ...
        self.customer_num_entry.grid(row=3, column=1, sticky="ew", padx=5, pady=5)
        ...
        self.qid_entry.grid(row=3, column=3, sticky="ew", padx=5, pady=5)
        ...
        self.project_entry.grid(row=4, column=1, sticky="ew", padx=5, pady=5)
        ...
        self.notes_entry.grid(row=4, column=3, sticky="ew", padx=5, pady=5)
